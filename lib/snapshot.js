    ...
    .then(([contacts, participants, messages, ...sync]) => {
      ...
      contacts = contacts
        ...
        .sort((firstContact, secondContact) => {
          ...
          let fcLength = fc.messages.length
          let scLength = sc.messages.length
          let fcLatest = fc.messages[fcLength - 1].timestamp
          let scLatest = sc.messages[scLength - 1].timestamp
