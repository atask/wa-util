...
const defaultMsgStorePath = path.join(baseDir, 'msgstore.db')
const defaultWaPath = path.join(baseDir, 'wa.db')
const defaultDbDir = path.join(baseDir, 'in')
...
function waDbLoad ({
  msgstorePath = defaultMsgStorePath,
  waPath = defaultWaPath,
  targetDayString = todayIsoString
}) {
